      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.top}>
          ...
          <div className={styles.socials}>
            <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className={styles.social} aria-label="WhatsApp">
        ...
        <div className={styles.links}>
          <div className={styles.col}>
            ...
            <Link href="/consult" className={styles.colLink}>Request Consultation</Link>
            <a href="/#areas" className={styles.colLink}>Practice Areas</a>
            <a href="/#why" className={styles.colLink}>Why Choose Us</a>
            <a href="/#testimonials" className={styles.colLink}>Testimonials</a>
          </div>
          <div className={styles.col}>
            ...
            <Link href="/disclaimer" className={styles.colLink}>Legal Disclaimer</Link>
          </div>
          <div className={styles.col}>
